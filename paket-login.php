    ...
    <nav class="navbar shadow fixed-top bg-1">
        <div class="container">
            ...
            <ul class="nav nav-underline ms-auto">
                ...
                <li class="nav-item pt-2">
                    <a class="nav-link active" aria-current="page" href="http://localhost/ProjekAkhir/paket-login.php">Paket Belajar</a>
                </li>
                <li class="nav-item pt-2">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col text-center">
                ...
                <a class="btn btn-light fw-bold fs-5 mt-3" href="https://pahamify.com/download/" role="button" style="width: 230px; border-radius: 20px;">Download Aplikasi</a>
            </div>
        </div>
    </div>
